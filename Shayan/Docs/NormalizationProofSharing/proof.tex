...
\usepackage[pdfauthor={Shayan Najd},pdftitle={Sharing-Preserving Normaliser},pagebackref=true,pdftex]{hyperref}
\usepackage{titling}
\usepackage{pbox}
\usepackage{tabularx}
\usepackage{amsthm}
...
\begin{document}
\title{Sharing-Preserving Normalisation}
\author{Shayan Najd}
\maketitle
\section*{Introduction}
In this report, I describe a sharing-preserving normalisation algorithm.

The normalisation algorithm takes as input a term and returns a
semantically equivalent term in normal form. In particular, we
...
The normalisation algorithm is sharing-preserving in the sense that
elimination of redexes does not duplicate terms; the normalisation
process preserves (most of) computational and syntactic sharing. That
is, (most of) originally shared computations are not computed twice at
runtime, and the size of abstract syntax tree does not increase.


\section{The Source Language}
Metavariables $x$, $y$, $z$, and $k$ range over variables. Wherever
variables are used, renaming of bound variables is allowed;
we work up to renamings.

When needed, metavariables (of any kind) are decorated with indices.

Types are \textbf{closed} expressions defined by the abstract syntax in
Figure~\ref{fig:typ}.
...
Terms are \textbf{open} expressions defined by the abstract syntax in
Figure~\ref{fig:exp}.
...
%Moreover, the notation $count(x,N)$ is used to denote a
...
fonts in typing rules; removing the red bits (i.e. terms and typing
relation symbol $:$) from the typing rules yields the corresponding
...
Rewrite rules, denoted as $\rewrite{}{i}{}$ for phase $i$, are defined
in Figure~\ref{fig:red}. The metavariables $\mathbb{C}$, and
$\mathbb{F}$ denote capture-allowing evaluation frames.  The
evaluation frame $\mathbb{C}$, whose definition is ommited, is the
standard complatible frame, where a hole can possibly appear in place
of every single subterm. The metafunctions defined for terms carry
over to evaluation frames trivially. The metavariable $\nx$ denotes
terms that are not variable.
...
\begin{array}[t]{@{}llll@{}}
 ...
 %-------------------------------------------------
\multicolumn{4}{@{}c@{}}{\txt{Phase 1}}\\[-8pt]
\multicolumn{4}{@{}c@{}}{\rule{120pt}{1pt}}\\[1pt]
%-------------------------------------------------

\multicolumn{4}{@{}l@{}}{\mathbb{F} \mathbin{\ ::=\ }
    \expapp{\hole}{M}\
 |\ \expapp{z}{\hole}\
 |\ \expprd{\hole}{N}\
 |\ \expprd{x}{\hole}\
...
& \expshr{z}{\nx}{\mathbb{F}[z]}
\\[0pt]
\multicolumn{4}{@{}l@{}}{\txt{\ \ \ \ where\ \ \ }\fresh{z}}\\[0pt]

%-------------------------------------------------
\multicolumn{4}{@{}c@{}}{\txt{Phase 2}}\\[-8pt]
\multicolumn{4}{@{}c@{}}{\rule{120pt}{1pt}}\\[1pt]
%-------------------------------------------------

(\kappa_{\lambda\txt{-let}})
& \expabs{x}{A}{\mathbb{C}[\expshr{y}{M}{N}]}
& \ \rewrite{}{2}{}\ \
& \expshr{y}{M}{\expabs{x}{A}{\mathbb{C}[N]}}
\\[0pt]
\multicolumn{4}{@{}l@{}}{\txt{\ \ \ \ where\ \ \ }x \notin \fv{M}\txt{, and }\fv{M} \subset \mathbb{C}[N]}
\\[10pt]

%-------------------------------------------------
\multicolumn{4}{@{}c@{}}{\txt{Phase 3}}\\[-8pt]
\multicolumn{4}{@{}c@{}}{\rule{120pt}{1pt}}\\[1pt]
%-------------------------------------------------
...
(\kappa_{\txt{let-case}})
& \expshrind{z}{\expcasind{z_0}{x}{M}{y}{N}}{L}
& \ \rewrite{}{3}{}\ \
& \expshrind{k}{\expabs{z}{A}{L}}{\expcasindind{z_0}{x}{\expshr{z}{M}{\expapp{k}{z}}}{y}{\expshr{z}{N}{\expapp{k}{z}}}}
%% \\[0pt]
%% \multicolumn{4}{@{}l@{}}{\txt{\ \ \ \ where\ \ \ }\fresh{k}}
\\[10pt]


(\beta_{\rightarrow})
& \expshrind{z}{\expabs{x}{A}{N}}{\mathbb{C}[\expapp{z}{y}]} %%  \expapp{(\expabs{x}{A}{N})}{V}
& \ \rewrite{}{3}{}\ \
& \expshrind{z}{\expabs{x}{A}{N}}{\mathbb{C}[\sbs{N}{x}{y}]}
\\[10pt]

(\beta_{\times_1})
& \expshrind{z}{\expprd{x}{y}}{\mathbb{C}[\expfst{z}]}
& \ \rewrite{}{3}{}\ \
& \expshrind{z}{\expprd{x}{y}}{\mathbb{C}[x]}
\\[10pt]

(\beta_{\times_2})
& \expshrind{z}{\expprd{x}{y}}{\mathbb{C}[\expsnd{z}]}
& \ \rewrite{}{3}{}\ \
& \expshrind{z}{\expprd{x}{y}}{\mathbb{C}[y]}
\\[10pt]

(\beta_{+_1})
& \expshrind{z}{\explft{x_1}{B}}{\mathbb{C}[\expcas{z}{x}{M}{y}{N}]}
& \ \rewrite{}{3}{}\ \
& \expshrind{z}{\explft{x_1}{B}}{\mathbb{C}[\sbs{M}{x}{x_1}]}
\\[10pt]

(\beta_{+_2})
& \expshrind{z}{\exprgt{A}{x_2}}{\mathbb{C}[\expcas{z}{x}{M}{y}{N}]}
& \ \rewrite{}{3}{}\ \
& \expshrind{z}{\explft{A}{x_2}}{\mathbb{C}[\sbs{N}{y}{x_2}]}
\\[10pt]
...
%-------------------------------------------------
\multicolumn{4}{@{}c@{}}{\txt{Phase 4}}\\[-8pt]
\multicolumn{4}{@{}c@{}}{\rule{120pt}{1pt}}\\[1pt]
%-------------------------------------------------
...
%-------------------------------------------------
\multicolumn{4}{@{}c@{}}{\txt{Phase 5}}\\[-8pt]
\multicolumn{4}{@{}c@{}}{\rule{120pt}{1pt}}\\[1pt]
%-------------------------------------------------
...
\\[0pt]
\multicolumn{4}{@{}l@{}}{\txt{\ \ \ \ where\ \ \ }\env \vdash \typing{L}{\typarr{A}{B}},\ L \neq \expabs{y}{A}{N}\txt{, and }\fresh{x}}
\\[0pt]

(\beta_{let-\lambda})
& \expshrind{z}{(\expabs{x}{A}{M})}{N}
& \ \rewrite{}{5}{}\ \
& \sbs{N}{z}{(\expabs{x}{A}{M})}
\\[0pt]
...
One-step reduction relation for each phase, denoted as
$\reduce{}{i}{}$ for phase $i$, is compatible closure of the
corresponding rewrite rule $\rewrite{}{i}{}$. One-step reduction
relation for phase 5 has an extra condition such that a redex should
not be immediately at the left-hand side of an application,
i.e. $\mathbb{E} \neq \mathbb{{E}'}[\expapp{\hole}{M}]$ for the
compatible contexts $\mathbb{E}$ and $\mathbb{{E}'}$.
...
$\reducestar{}{}{}$, is composition of the reduction for all five
phases,
i.e. $\reducestar{}{5}{}\circ\reducestar{}{4}{}\circ\reducestar{}{3}{}\circ\reducestar{}{2}{}\circ\reducestar{}{1}{}$.
...
%% \label{prop_normal}
%% A term $M$ is in normal form, if and only if, it matches the
...
%% Reduction preserves the type of the source term:
