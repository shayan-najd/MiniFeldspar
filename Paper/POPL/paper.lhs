% Phil's notes on rereading paper.

% Intro does go on. Get to meat earlier.

% Use of save in definition of memorise is not required, and subformula
% property cannot guarantee absence of intermediate arrays.

% phase i --> Phase i

% Review two different sections on limitations of normalisation.
